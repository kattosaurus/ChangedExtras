...
public class FurredLatexTigerShark<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "furredlatextigershark"), "main");
	...
	public FurredLatexTigerShark(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		.texOffs(79, 17).addBox(-3.5F, -3.0F, -5.0F, 7.0F, 3.0F, 3.0F, new CubeDeformation(0.01F)), PartPose.offset(0.0F, -0.5F, 0.0F));

		PartDefinition Snout_r1 = Head.addOrReplaceChild("Snout_r1", CubeListBuilder.create().texOffs(55, 57).addBox(0.0F, 0.0F, 0.0F, 1.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.5F, -3.01F, -5.0F, 0.0F, -0.2182F, 0.0F));

		PartDefinition Snout_r2 = Head.addOrReplaceChild("Snout_r2", CubeListBuilder.create().texOffs(0, 59).addBox(-1.0F, 0.0F, 0.0F, 1.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.5F, -3.01F, -5.0F, 0.0F, 0.2182F, 0.0F));
		...
		PartDefinition Base_r2 = Head.addOrReplaceChild("Base_r2", CubeListBuilder.create().texOffs(60, 20).addBox(-2.1809F, -1.0F, -0.5736F, 3.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.5F, -1.4F, -1.5F, 0.5236F, 0.9599F, 0.0F));

		PartDefinition Cheekfur = Head.addOrReplaceChild("Cheekfur", CubeListBuilder.create(), PartPose.offset(0.0F, 26.0F, 2.0F));

		PartDefinition Snout_r3 = Cheekfur.addOrReplaceChild("Snout_r3", CubeListBuilder.create().texOffs(87, 0).addBox(-3.5F, -30.0F, -6.0F, 5.0F, 4.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.5672F, 0.0F));

		PartDefinition Snout_r4 = Cheekfur.addOrReplaceChild("Snout_r4", CubeListBuilder.create().texOffs(86, 5).addBox(-3.5F, -31.0F, -6.0F, 5.0F, 5.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.0F, 0.0F, 1.0F, 0.0F, 0.5672F, 0.0F));

		PartDefinition Cheekfur2 = Head.addOrReplaceChild("Cheekfur2", CubeListBuilder.create(), PartPose.offset(0.0F, 26.0F, 2.0F));

		PartDefinition Snout_r5 = Cheekfur2.addOrReplaceChild("Snout_r5", CubeListBuilder.create().texOffs(87, 0).mirror().addBox(-1.5F, -30.0F, -6.0F, 5.0F, 4.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -0.5672F, 0.0F));

		PartDefinition Snout_r6 = Cheekfur2.addOrReplaceChild("Snout_r6", CubeListBuilder.create().texOffs(86, 5).mirror().addBox(-1.5F, -31.0F, -6.0F, 5.0F, 5.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(1.0F, 0.0F, 1.0F, 0.0F, -0.5672F, 0.0F));
		...
		PartDefinition Hair_r1 = Hair.addOrReplaceChild("Hair_r1", CubeListBuilder.create().texOffs(86, 24).addBox(-3.5F, -31.0F, -6.1F, 5.0F, 5.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(24.0F, 7.0F, 2.0F, 0.0F, 0.0F, -0.9488F));

		PartDefinition Hair_r2 = Hair.addOrReplaceChild("Hair_r2", CubeListBuilder.create().texOffs(86, 10).addBox(-3.5F, -31.0F, -6.0F, 5.0F, 5.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(24.0F, 8.0F, -4.0F, 2.9949F, 0.2448F, 2.1363F));

		PartDefinition Hair_r3 = Hair.addOrReplaceChild("Hair_r3", CubeListBuilder.create().texOffs(86, 5).addBox(-3.5F, -31.0F, -6.0F, 5.0F, 5.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-5.0F, 21.0F, 8.0F, 0.137F, 0.5522F, 0.257F));

		PartDefinition Hair_r4 = Hair.addOrReplaceChild("Hair_r4", CubeListBuilder.create().texOffs(86, 5).mirror().addBox(-1.5F, -31.0F, -6.0F, 5.0F, 5.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(5.0F, 21.0F, 8.0F, 0.137F, -0.5522F, -0.257F));

		PartDefinition Hair_r5 = Hair.addOrReplaceChild("Hair_r5", CubeListBuilder.create().texOffs(86, 5).mirror().addBox(-1.5F, -31.0F, -6.0F, 5.0F, 5.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-1.0F, 23.0F, 3.0F, 0.0F, -0.5672F, 0.0F));

		PartDefinition Hair_r6 = Hair.addOrReplaceChild("Hair_r6", CubeListBuilder.create().texOffs(86, 5).addBox(-3.5F, -31.0F, -6.0F, 5.0F, 5.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, 23.0F, 3.0F, 0.0F, 0.5672F, 0.0F));
