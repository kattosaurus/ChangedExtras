...
public class FurredLatexTigerSharkEntityModel extends AdvancedHumanoidModel<FurredLatexTigerSharkEntity> {
    public static final ModelLayerLocation LAYER_LOCATION =
            new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(ChangedExtras.MODID, "furred_latex_tiger_shark"), "main");
    ...
    private final HumanoidAnimator<FurredLatexTigerSharkEntity, FurredLatexTigerSharkEntityModel> animator;

    public FurredLatexTigerSharkEntityModel(ModelPart root) {
        super(root);
        ...
        ModelPart dummyCheek = root.getChild("DummyCheek");

        this.animator = HumanoidAnimator.of(this).hipOffset(-1.5f)
                .addPreset(AnimatorPresets.wolfLike(
                        this.Head, dummyCheek, dummyCheek,
                        this.Torso, this.LeftArm, this.RightArm,
                        this.Tail, List.of(this.TailPrimary, this.TailSecondary, this.TailTertiary),
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        partdefinition.addOrReplaceChild("DummyCheek", CubeListBuilder.create(), PartPose.ZERO);
    ...
    @Override
    public void setupHand(FurredLatexTigerSharkEntity entity) {
        animator.setupHand();
    }

    @Override
    public void setupAnim(@NotNull FurredLatexTigerSharkEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
    ...
    @Override
    public HumanoidAnimator<FurredLatexTigerSharkEntity, ?> getAnimator(FurredLatexTigerSharkEntity entity) {
        return animator;
    }
