...
public class FluffedUpLatexSnowLeopardFemaleEntityModel extends AdvancedHumanoidModel<FluffedUpLatexSnowLeopardFemaleEntity> {
    // This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
    public static final ModelLayerLocation LAYER_LOCATION =
            new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(ChangedExtras.MODID, "fluffed_up_latex_snow_leopard_female"), "main");
    ...
    private final HumanoidAnimator<FluffedUpLatexSnowLeopardFemaleEntity, FluffedUpLatexSnowLeopardFemaleEntityModel> animator;

    public FluffedUpLatexSnowLeopardFemaleEntityModel(ModelPart root) {
        super(root);
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition Hair = Head.addOrReplaceChild("Hair", CubeListBuilder.create().texOffs(0, 78).addBox(-4.5F, -32.9F, -4.0F, 8.0F, 10.0F, 8.0F, new CubeDeformation(0.35F))
                .texOffs(39, 77).addBox(-4.5F, -33.9F, -4.0F, 8.0F, 11.0F, 8.0F, new CubeDeformation(0.2F)), PartPose.offset(0.5F, 26.0F, 0.0F));

        PartDefinition Torso = partdefinition.addOrReplaceChild("Torso", CubeListBuilder.create().texOffs(28, 37).addBox(-4.0F, 9.1F, -2.0F, 8.0F, 3.0F, 4.0F, new CubeDeformation(0.1F))
                .texOffs(28, 28).addBox(-4.0F, 0.5F, -2.0F, 8.0F, 5.0F, 4.0F, new CubeDeformation(0.0F))
                .texOffs(28, 31).addBox(-4.0F, 4.5F, -2.0F, 8.0F, 6.0F, 4.0F, new CubeDeformation(-0.3F)), PartPose.offset(0.0F, -0.5F, 0.0F));
        ...
        PartDefinition Center_r1 = Plantoids.addOrReplaceChild("Center_r1", CubeListBuilder.create().texOffs(39, 79).addBox(-0.5F, -1.3F, -0.1F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.2F)), PartPose.offsetAndRotation(0.0F, 2.0F, 0.0F, -0.192F, 0.0F, 0.0F));
    ...
    @Override
    public void setupHand(FluffedUpLatexSnowLeopardFemaleEntity entity) {
        animator.setupHand();
    }
    @Override
    public void setupAnim(@NotNull FluffedUpLatexSnowLeopardFemaleEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
    ...
    @Override
    public HumanoidAnimator<FluffedUpLatexSnowLeopardFemaleEntity, ?> getAnimator(FluffedUpLatexSnowLeopardFemaleEntity entity) {
        return animator;
    }
